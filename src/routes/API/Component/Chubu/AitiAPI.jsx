...
const  HokkaidoAPI=()=>{
    ...
    useEffect(()=>{
    const getAPI=async()=>{
        const response=await axios.get("https://app.rakuten.co.jp/services/api/Travel/KeywordHotelSearch/20170426?format=json&keyword=%E3%82%B9%E3%83%8E%E3%83%9C&middleClassCode=hokkaido&applicationId=1001318956766170232");
